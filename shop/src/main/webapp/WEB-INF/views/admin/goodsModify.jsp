...
<body>
                    ...
                    <div class="admin_content_main">
                    	<form action="/admin/goodsModify" method="post" id="modifyForm">
                    		...
                    		<div class="form_section">
                    			...
                    			<div class="form_section_content">
                    				<input name="publiYear" autocomplete="off" readonly="readonly">
                    				<span class="ck_warn publiYear_warn">출판일을 선택해주세요.</span>
                    			</div>
                    		</div>            
                    		<div class="form_section">
                    			<div class="form_section_title">
                    		...
                    		<input type="hidden" name='bookId' value="${goodsInfo.bookId}">
                   			...
                   			<div class="btn_section">
	                    		...
	                    		<button id="modifyBtn" class="btn modify_btn">수정 완료</button>
	                    	</div> 
                    </div>  
	...
	<script>
		$(document).ready(function(){
			...
			/* 캘린더 */
			$(function() {
				let publiYear = '${goodsInfo.publiYear}';
				$("input[name='publiYear']").datepicker(config);
				$("input[name='publiYear']").datepicker('setDate', publiYear);
			});
	...
	<script>
		...
		$("#modifyBtn").on("click", function(e){
			...
			let publiYear = $("input[name='publiYear']").val();
			...
			if(publiYear){
				$(".publiYear_warn").css('display','none');
				publiYearCk = true;
			} else {
				$(".publiYear_warn").css('display','block');
				publiYearCk = false;
			}	
			...
			/* 최종 확인 */
			if(bookNameCk && authorIdCk && publiYearCk && publisherCk && cateCodeCk && priceCk && stockCk && discountCk && introCk && contentsCk ){
				$("#modifyForm").submit();
			} else {
				return false;
			}			
