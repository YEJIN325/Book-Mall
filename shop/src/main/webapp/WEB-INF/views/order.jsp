					...
					<table class="point_table">
						...
						<tbody>
							<tr>
								<th>포인트 사용</th>
								<td>
									${memberInfo.point}P 보유 | <input class="order_point_input" value="0">원 
				...
				<div class="total_info_div">
					...
					<div class="total_info_price_div">
						<ul>
							...
							<li>
								<span class="price_span_label">포인트 사용</span>
...
<script>
	...
	// 총 주문 정보 세팅 (배송비, 총 가격, 포인트, 상품 수, 종류)
